...
gwc/run.py
==========
Runs the GWC (3x3 Grid World C) environment end-to-end:
...
if __name__ == '__main__':
    ...
    # All reachable non-terminal states to explain
    ...
    #    Uses Maschler's sequential LP with 0-normalisation so that
    #    Nucleolus and Shapley share the same baseline v(∅).
    #    For n=2 features this makes both solutions mathematically equal.
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    FOCAL = tuple(states_to_explain[0])   # (0, 0)
